...
public class PersonResultPanel extends JPanel {
    public PersonResultPanel(QuizContainer container, int score, int total, java.util.List<PersonQuizResult> results) {
        ...
        // 점수 요약
        JLabel scoreLabel = new JLabel("총 " + total + "문제 중 " + score + "문제 정답!", SwingConstants.CENTER);
        ...
        for (PersonQuizResult result : results) {
