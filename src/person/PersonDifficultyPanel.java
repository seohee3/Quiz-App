...
public class PersonDifficultyPanel extends JPanel {
    public PersonDifficultyPanel(QuizContainer container, String category) {
        ...
        for (String level : levels) {
            ...
            btn.addActionListener(_ -> {
                container.goToCount("인물 퀴즈", category, level); // 다음 단계로 전환
            });
            buttonPanel.add(btn);
        }
