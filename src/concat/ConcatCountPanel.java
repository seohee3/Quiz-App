...
public class ConcatCountPanel extends JPanel {
    private int count = 10;
    private JLabel countLabel;

    public ConcatCountPanel(QuizContainer container, String quizType, String category, String difficulty, String questionType) {
        ...
        JButton nextButton = new StyledButton("다음");
        nextButton.addActionListener(_ -> {
            container.setCurrentQuizCount(count); // 선택한 문항 수 저장
            container.goToTypeSelection(quizType, category, difficulty);
        });
