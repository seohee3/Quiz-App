// src/initial/InitialCountPanel.java
package initial;
...
public class InitialCountPanel extends JPanel {
  private int count = 10;
  private JLabel countLabel;

  public InitialCountPanel(QuizContainer container, String quizType, String category, String difficulty) {
    ...
    startButton.addActionListener(_ -> {
      container.startQuiz(quizType, category, difficulty, count, "none");
    });
