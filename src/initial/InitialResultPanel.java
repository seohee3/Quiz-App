...
public class InitialResultPanel extends JPanel {
  public InitialResultPanel(int total, int correct, List<InitialQuizResult> results, QuizContainer container) {
    ...
    // 결과 테이블
    String[] columns = { "번호", "문제", "내가 쓴 답", "정답" };
    DefaultTableModel tableModel = new DefaultTableModel(columns, 0);

    for (InitialQuizResult result : results) {
